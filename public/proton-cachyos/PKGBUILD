...
source=(
    ...
    0001-proton-unset-DISPLAY-only-if-it-is-set.patch
    0002-build-enable-gstreamer-surfaceless-display.patch
...
prepare() {
    ...
    patch -Np1 -i "$srcdir"/0001-proton-unset-DISPLAY-only-if-it-is-set.patch
    patch -Np1 -i "$srcdir"/0002-build-enable-gstreamer-surfaceless-display.patch
...
sha256sums=('d5d99a76c444597062114b5a48f70bcea3ad715e02b138ceae777605c103f337'
            ...
            'bd8698eb72e2a9cae478936e98e8b372604d9782b1cc3ca3a74c41c0751371e5'
            'b6653d1d8052ef26db047791cde700141cdb7fff712e0fe76a511f4e6c1c0126'
