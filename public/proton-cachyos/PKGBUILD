...
build() {
    ...
    CFLAGS="-O3 -march=$march -mtune=$mtune -pipe -fno-semantic-interposition -fipa-pta"
    CXXFLAGS="-O3 -march=$march -mtune=$mtune -pipe -fno-semantic-interposition -fipa-pta"
