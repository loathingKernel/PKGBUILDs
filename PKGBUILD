...
build() {
  ...
  ./configure --enable-32-bit \
    ...
    # --with-llvm-shared-libs \ # enabling this would force us to move lib32-llvm-amdgpu-snapshot from community to extra, delay it until llvm 3.3 / Mesa 9.2/10.0
  make
...
package_lib32-mesa() {
  ...
  depends=('lib32-libdrm' 'lib32-libxxf86vm' 'lib32-libxdamage' 'lib32-systemd' 'lib32-mesa')
...
package_lib32-mesa-libgl() {
  ...
  conflicts=('lib32-nvidia-utils' 'lib32-catalyst-utils' 'lib32-libgl')
