...
package_lib32-mesa-libgl() {
  ...
  ln -s /usr/lib32/mesa/libGLESv1-CM.so.1.1.0 ${pkgdir}/usr/lib32/libGLESv1-CM.so.1.1.0
  ln -s libGLESv1_CM.so.1.1.0	              ${pkgdir}/usr/lib32/libGLESv1-CM.so.1
  ln -s libGLESv1_CM.so.1.1.0                 ${pkgdir}/usr/lib32/libGLESv1-CM.so
