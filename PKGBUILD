...
pkgrel=4
arch=(x86_64)
makedepends=('glproto>=1.4.11' 'pkgconfig' 'lib32-libdrm>=2.4.21' 'lib32-libxxf86vm>=1.1.0' 'lib32-libxdamage>=1.1.2' 'lib32-expat>=2.0.1' 'lib32-libx11>=1.3.3' 'lib32-libxt>=1.0.8' 'lib32-gcc-libs>=4.5' 'dri2proto=2.3' 'python')
...
package_lib32-mesa() {
  depends=('lib32-libgl' 'lib32-libx11>=1.3.3' 'lib32-libxt>=1.0.8' 'lib32-gcc-libs>=4.5' 'dri2proto=2.3' 'lib32-libdrm>=2.4.20' 'glproto>=1.4.11' "mesa")
  ...
  install -D progs/xdemos/glxinfo "$pkgdir/usr/bin/glxinfo32"
